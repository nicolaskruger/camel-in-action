...
import camelinaction.AnnotatedRecipientList;
...
public class MyOrderRouterWithRecipientListTest extends CamelTestSupport {
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from(ROUTES.FILA_JSON)
                        .setHeader(RECIPENTS, method(AnimeRecipiesBean.class, METHOD))
                        .recipientList(header(RECIPENTS));
                from(ROUTES.FLCL)
                        .log(FLCL_$_BODY)
                        .to(ROUTES.MOCK_FLCL);
