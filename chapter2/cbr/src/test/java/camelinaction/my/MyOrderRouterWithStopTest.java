...
public class MyOrderRouterWithStopTest extends CamelTestSupport {
    ...
    private static final String FILA_CONTINUE = "jms:fila-continue";
    ...
    private static final String MOCK_CONTINUE = "mock:continue";
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                Arrays.asList(
                                ...
                                new Temp(FILA_CONTINUE, MOCK_CONTINUE))
                        .forEach(temp -> {
