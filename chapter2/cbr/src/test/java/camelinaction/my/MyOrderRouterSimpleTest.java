...
public class MyOrderRouterSimpleTest extends CamelTestSupport {
    ...
    private static final  String SIMPLE = "${header.CamelFileName} ends with '%s'";
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            private SimpleBuilder mySimple(String end){
                return simple(String.format(SIMPLE,end));
            }
